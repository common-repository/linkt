  ...
  /**
	...
	public function register_taxonomy () {
        ...
        $labels = array(
            ...
            'update_item' => sprintf( __( 'Update %s' , 'linkt' ), $this->single ),
            'add_new_item' => sprintf( __( 'Add New %s' , 'linkt' ), $this->single ),
            'new_item_name' => sprintf( __( 'New %s Name' , 'linkt' ), $this->single ),
            'parent_item' => sprintf( __( 'Parent %s' , 'linkt' ), $this->single ),
            'parent_item_colon' => sprintf( __( 'Parent %s:' , 'linkt' ), $this->single ),
            'search_items' =>  sprintf( __( 'Search %s' , 'linkt' ), $this->plural ),
            'popular_items' =>  sprintf( __( 'Popular %s' , 'linkt' ), $this->plural ),
            'separate_items_with_commas' =>  sprintf( __( 'Separate %s with commas' , 'linkt' ), $this->plural ),
            'add_or_remove_items' =>  sprintf( __( 'Add or remove %s' , 'linkt' ), $this->plural ),
            'choose_from_most_used' =>  sprintf( __( 'Choose from the most used %s' , 'linkt' ), $this->plural ),
